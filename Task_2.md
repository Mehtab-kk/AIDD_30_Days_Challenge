...
### Q.1: Why is using AI Development Agents (like Gemini CLI) for repetitive setup tasks better for your growth as a system architect?

**answer**:  Agher AI apka sara repeat wala kam kerlega to app free raho ge app ka time save rahe ga to bari soch ker sakte hain ke 
abh designing ,planning aur setup kese kerna boht hi kam waqat me.


**Example**: app ka chai ka hotel hain aur app yeh kam repeat kerte ho jese:
...
**Ager app iss kam ke koi helper rakhdo to app ka kam asan ho jae ga
  to AI bhi app ka helper hi ha**


### Q.2: Explain how the Nine Pillars of AIDD help a developer grow into an M-Shaped Developer.

**answer**: first **M_Shaped Developer**  asa developer jisko multipe skills ati ho jese (AI, codding,tools,etc)
Now **nine pillar in AIDD** inn pillars ki wajah se ham coding me expert ha hame coding asan lagti ha .
ninie pillars ki help se developer multiple skills me expert ho jata hain jis M_shaped developer kehte hain.

## 2. Vibe Coding vs Specification-Driven Development

### Q.1: Why does Vibe Coding usually create problems after one week?

**answer**: 1. vibe coding me app ki koi planning nahi hoti
2. vibe coding me app sahi se structure define nahi kerte.
3. vibe coding app koi problem solve nahi kerte just fun kerte hain .

yahi kuch wajah ha ke app vibe coding hafte baad problem create kerte hain.
